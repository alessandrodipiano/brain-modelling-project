...
def network(mu1, mu2, condition=None, ): 
    ...
    #gEEN is the parameter targeted in the disturbed network condition
    gEEN_base = 0.165 * nS / NE * 1600  # excitatory -> excitatory neurons (NMDA)
    ...
    # decides between a control network and a lowered E/I ration network
